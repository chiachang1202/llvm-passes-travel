...
define i32 @main() #0 {
  ...
  %8 = call i32 @foo(i32 1)
  store i32 %8, i32* %2, align 4
  %9 = call i32 @bar(i32 2)
...
13:                                               ; preds = %10
  ...
  %16 = call i32 @bar(i32 %15)
  %17 = add nsw i32 %14, %16
  %18 = load i32, i32* %7, align 4
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds [2 x i32], [2 x i32]* %4, i64 0, i64 %19
  store i32 %17, i32* %20, align 4
  %21 = load i32, i32* %7, align 4
  %22 = load i32, i32* %7, align 4
  %23 = call i32 @foo(i32 %22)
...
31:                                               ; preds = %10
  ...
  %36 = call i32 @baz(i32 %33, i32 %35)
  store i32 %36, i32* %6, align 4
  %37 = load i32, i32* %2, align 4
  ret i32 %37
}

declare i32 @baz(i32, i32) #1
